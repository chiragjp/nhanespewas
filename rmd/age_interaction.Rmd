...
#            quantile((expo_age_40-expo_age_80), probs=.25, na.rm=T), 
#            quantile((expo_age_40-expo_age_80), probs=.75, na.rm=T))
...
Extended Data Figure 6 Source Data
```{r}
# Panel A and B
p4$data |> select (expo_age_40, expo_age_80, estimate_overall) |> write.csv(file="ExtFig6_PanelA-B.csv")
# Panel C
adjusted_meta_2 |> select(rsq_int_base_diff,rsq_adjusted_base_diff) |> write.csv(file="ExtFig6_PanelC.csv")
```
