...
rsq_summary <- rsq_summary_20 |> left_join(rsq_summary_10, by = "phenotype", suffix = c("_20", "_10")) 
...
pheno_desc <- pheno_desc |> mutate(pvardesc = ifelse(is.na(pvardesc), pvarname, pvardesc))
