...
Extended Data Figure 3 Source Data
```{r}
# Panel A
histogram_p$data |> select(scenario_label, estimate_adjusted, estimate) |> write.csv(file="ExtFig3_PanelA.csv")
# Panel B
voe_p$data |> select(scenario_label, estimate, evardesc,std.error.x) |> write.csv(file="ExtFig3_PanelB.csv")
