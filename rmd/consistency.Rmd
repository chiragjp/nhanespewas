...
p <- p +  theme_bw() + theme(legend.title=element_blank()) + xlab("Effect Size of Blood Biomarker") + ylab("Effect Size of Urinary Biomarker")
p
...
p <- p +  theme_bw() + theme(legend.title=element_blank())  + xlab("Effect Size of Blood Biomarker") + ylab("Effect Size of Self-Report Exposure")
p
