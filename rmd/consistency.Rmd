...
Extended Data Figure 4 Source Data
```{r}
ds |> select(evarname_DS1, evarname_DS2, estimate_DS1, estimate_DS2, sig_levels_DS1) |> write.csv(file="ExtFig4_PanelA.csv")
lbx_sr |> select(estimate_lbx, estimate_sr, sig_levels_lbx, lbx_sr_name) |> write.csv(file="ExtFig4_PanelB.csv")
lbx_urx |> select(estimate_lbx, estimate_urx, sig_levels_lbx, urx_lbx_name) |> write.csv(file="ExtFig4_PanelC.csv")
```
