...
## Architecture of Phenotype-Exposure Correlations
...
glanced_summary <- glanced_overall_wide |> mutate(total_n = nobs_2_0, rsq_adjusted_base_diff = rsq_2_0-rsq_2_1, rsq_adjusted_diff=rsq_2_0-rsq_1_0) |> select(evarname, pvarname, rsq_adjusted_base_diff, rsq_adjusted_diff)
