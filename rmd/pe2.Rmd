...
overall_model_2  <- pe_overall |> filter(model_number == 2, term == 'expo') |> collect() |> rename(evarname=exposure, pvarname=phenotype)
adjusted_meta_full_2 <- adjusted_meta_full |> left_join(overall_model_2, by=c("evarname", "pvarname"))
