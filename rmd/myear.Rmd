...
country <- DBI::dbConnect(RSQLite::SQLite(), dbname='../db/nhanes_012324.sqlite')
...
jack <- pe_flex_adjust("BMXBMI", "LBXBCD", adjustment_models, country, scale_p=T)
test <- pe_flex_adjust("URXUCL", "URXUCR", adjustment_models, country, scale_p=T, scale_e=F, exposure_levels = c(1,2))
#jack2 <- pe_flex_adjust("LBXCRP", "LBXGTC", adjustment_models, con, scale_p=T)
## pick a table if tied
```
